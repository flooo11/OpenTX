...
local function Config_Draw_Edit( event )
  ...
  -- Editable Hex value
    ...
    if LCD_W == 480 then
      lcd.drawText(170, 130, "Sauver", attrib)
    else
      lcd.drawText(17, 30, "Sauver", attrib + SMLSIZE)
    end
    ...
    if LCD_W == 480 then
      lcd.drawText(260, 130, "Annuler", attrib)
    else
      lcd.drawText(77, 30, "Annuler", attrib + SMLSIZE)
    end
  ...
  -- Action text
    ...
    if LCD_W == 480 then
      lcd.drawText(170, 130, "Oui", attrib)
    else
      lcd.drawText(17, 30, "Oui", attrib + SMLSIZE)
    end
    if Edit_pos == 2 then
      attrib = INVERS
    else
    ...
    if LCD_W == 480 then
      lcd.drawText(260, 130, "Non", attrib)
    else
      lcd.drawText(77, 30, "Non", attrib)
    end
  end
end
...
-- Main menu
  ...
  if LCD_W == 480 then
    ...
    lcd.drawText(1, 5, "Config Multi " .. Version, MENU_TITLE_COLOR)
    if multiBuffer(13) == 0x00 then
      lcd.drawText(10,50,"Pas de Config telemetry...", BLINK)
    end
  else
    --Draw on LCD_W=128
    lcd.drawText(1, 0, "Config Multi " .. Version, SMLSIZE)
    if multiBuffer(13) == 0x00 then
      lcd.drawText(2,17,"Pas de Config telemetry...",SMLSIZE)
    end
  end
