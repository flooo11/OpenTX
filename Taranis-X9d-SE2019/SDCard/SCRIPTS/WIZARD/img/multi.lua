...
local function drawThrottleMenu()
  lcd.clear()
  lcd.drawText(1, 0, "Voie pour les moteurs", 0)
  ...
  lcd.drawText(20, LCD_H-16, "Choisir Moteur", 0);
  lcd.drawText(20, LCD_H-8, "VOIE", 0);
...
local function drawRollMenu()
  lcd.clear()
  lcd.drawText(1, 0, "Voie pour le Roulis (Roll)", 0)
  lcd.drawFilledRectangle(0, 0, LCD_W, 8, GREY_DEFAULT+FILL_WHITE)
  lcd.drawLine(LCD_W/2-1, 18, LCD_W/2-1, LCD_H-1, DOTTED, 0)
  lcd.drawPixmap(120, 8, "img/multi-roll.bmp")
  lcd.drawText(20, LCD_H-16, "Choisir Roulis", 0);
  lcd.drawText(20, LCD_H-8, "VOIE", 0);
  lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
...
local function drawPitchMenu()
  lcd.clear()
  lcd.drawText(1, 0, "Voie pour le Tangage (Pitch)", 0)
  lcd.drawFilledRectangle(0, 0, LCD_W, 8, GREY_DEFAULT+FILL_WHITE)
  lcd.drawLine(LCD_W/2-1, 18, LCD_W/2-1, LCD_H-1, DOTTED, 0)
  lcd.drawPixmap(120, 8, "img/multi-pitch.bmp")
  lcd.drawText(20, LCD_H-16, "Choisir Tangage", 0);
  lcd.drawText(20, LCD_H-8, "VOIE", 0);
  lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
...
local function drawYawMenu()
  lcd.clear()
  lcd.drawText(1, 0, "Voie pour le Lacet (Yaw)", 0)
  lcd.drawFilledRectangle(0, 0, LCD_W, 8, GREY_DEFAULT+FILL_WHITE)
  lcd.drawLine(LCD_W/2-1, 18, LCD_W/2-1, LCD_H-1, DOTTED, 0)
  lcd.drawPixmap(120, 8, "img/multi-yaw.bmp")
  lcd.drawText(20, LCD_H-16, "Choisir Lacet", 0);
  lcd.drawText(20, LCD_H-8, "VOIE", 0);
  lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
...
local function drawArmMenu()
  lcd.clear()
  lcd.drawText(1, 0, "Selectionner inter pour armer", 0)
  lcd.drawFilledRectangle(0, 0, LCD_W, 8, GREY_DEFAULT+FILL_WHITE)
  lcd.drawLine(LCD_W/2-1, 18, LCD_W/2-1, LCD_H-1, DOTTED, 0)
  lcd.drawPixmap(120, 8, "img/multi-thr.bmp")
  lcd.drawText(20, LCD_H-16, "Choisir AUX1", 0);
  lcd.drawText(20, LCD_H-8, "Inter", 0);
  lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
...
local function drawbeeperMenu()
  lcd.clear()
  lcd.drawText(1, 0, "Selectionner inter pour le beeper", 0)
  lcd.drawFilledRectangle(0, 0, LCD_W, 8, GREY_DEFAULT+FILL_WHITE)
  lcd.drawLine(LCD_W/2-1, 18, LCD_W/2-1, LCD_H-1, DOTTED, 0)
  lcd.drawPixmap(120, 8, "img/multi-thr.bmp")
  lcd.drawText(20, LCD_H-16, "Choisir AUX2", 0);
  lcd.drawText(20, LCD_H-8, "Inter", 0);
  lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
...
local function drawmodeMenu()
  lcd.clear()
  lcd.drawText(1, 0, "Selectionner inter pour le mode", 0)
  lcd.drawFilledRectangle(0, 0, LCD_W, 8, GREY_DEFAULT+FILL_WHITE)
  lcd.drawLine(LCD_W/2-1, 18, LCD_W/2-1, LCD_H-1, DOTTED, 0)
  lcd.drawPixmap(120, 8, "img/multi-thr.bmp")
  lcd.drawText(20, LCD_H-16, "Choisir AUX3", 0);
  lcd.drawText(20, LCD_H-8, "Inter", 0);
  lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
...
local function drawConfirmationMenu()
  ...
  x, y = drawNextCHLine(x, y, "Moteur", thrCH1)
  x, y = drawNextCHLine(x, y, "Roulis", rollCH1)
  x, y = drawNextCHLine(x, y, "Tangage", pitchCH1)
  x, y = drawNextCHLine(x, y, "Lacet", yawCH1)
  x = 95
  y = 12
  x, y = drawNextSWLine(x, y, "Inter Armer", armSW1)
  x, y = drawNextSWLine(x, y, "Inter Beeper", beeperSW1)
  x, y = drawNextSWLine(x, y, "Inter Mode", modeSW1)
...
local function applySettings()
  ...
  addMix(rollCH1,  MIXSRC_FIRST_INPUT+defaultChannel(3), "Roulis")
  addMix(yawCH1,   MIXSRC_FIRST_INPUT+defaultChannel(0), "Tangag")
  addMix(pitchCH1, MIXSRC_FIRST_INPUT+defaultChannel(1), "Lacet")
  addMix(4, MIXSRC_SA + armSW1 - 1, "Armer")
